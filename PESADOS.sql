...
--   SUBSTR(a.completion_text,1,20)
 ...
 WHERE to_char(a.actual_completion_date, 'DD/MM/YYYY') = '15/12/2006'--to_char('10/11/2006', 'DD/MM/YYYY')--(select to_char(sysdate, 'DD/MM/YYYY') from dual)
   AND b.LANGUAGE = 'PTB'
   ...
   AND TRUNC((a.actual_completion_date - a.actual_start_date) * 60 * 24) > 30
 ORDER BY 5 desc